 ...
 */
public class LocationPickerAdapter implements ListAdapter {
    ...
    ArrayList<Store> mItemsCopy = new ArrayList<Store>();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (p.getBrand_logo() != null) {
            mNoPlaceholderImageLoader.loadImage(Config.PROD_BASE_URL+p.getBrand_logo(), photoView);
        }
