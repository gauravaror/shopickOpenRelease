 ...
 */
public class OfferBannerLikeJob extends Job {
    ...
    public OfferBannerLikeJob(String globalID) {
        super(new Params(Priority.MID).groupBy("offerbannerlikejob").persist().requireNetwork());
        this.globalID = globalID;
    }
    ...
    public Response<Post> likeOfferBanner() throws IOException {
        ...
        Call<Post> call = service.likeBanner(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
