...
/** 
 * DAO for table "TOP_CATEGORIES".
*/
public class TopCategoriesDao extends AbstractDao<TopCategories, Long> {

    public static final String TABLENAME = "TOP_CATEGORIES";

    /**
     * Properties of entity TopCategories.<br/>
    ...
    */
    ...
    public TopCategoriesDao(DaoConfig config) {
        super(config);
    }
    
    public TopCategoriesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TOP_CATEGORIES\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TOP_CATEGORIES\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TopCategories entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TopCategories readEntity(Cursor cursor, int offset) {
        TopCategories entity = new TopCategories( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TopCategories entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TopCategories entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TopCategories entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
