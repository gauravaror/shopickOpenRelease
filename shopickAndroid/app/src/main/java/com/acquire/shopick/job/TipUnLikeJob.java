 ...
 */
public class TipUnLikeJob extends Job {
    ...
    public TipUnLikeJob(String globalID_) {
    ...
    public Response<Post> unlikeTip() throws IOException {
        ...
        Call<Post> call = service.unlikeTip(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
