...
public class BrandUpdateLikeJob extends Job {
    @Inject
    ...
    public BrandUpdateLikeJob(String globalID) {
        super(new Params(Priority.MID).groupBy("brandupdatelike").persist().requireNetwork());
        this.globalID = globalID;
    }
    ...
    public Response<Post> likeBrandUpdate() throws IOException {
        ...
        Call<Post> call = service.likeBrandUpdate(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
