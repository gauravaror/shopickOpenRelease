...
public class PostCollectionLikeJob extends Job {
    ...
    public PostCollectionLikeJob(String globalID) {
        super(new Params(Priority.MID).groupBy("post_collection_like").persist().requireNetwork());
        this.globalID = globalID;
    }
    ...
    public Response<Post> likePostCollection() throws IOException {
        ...
        Call<Post> call = service.likePostCollection(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
