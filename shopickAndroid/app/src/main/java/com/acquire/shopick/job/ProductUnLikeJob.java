 ...
 */
public class ProductUnLikeJob extends Job {
    ...
    public ProductUnLikeJob(String globalID_) {
        super(new Params(Priority.MID).groupBy("productunlike").persist().requireNetwork());
    ...
    public Response<Post> unlikeProduct() throws IOException {
        ...
        Call<Post> call = service.unlikeProduct(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
