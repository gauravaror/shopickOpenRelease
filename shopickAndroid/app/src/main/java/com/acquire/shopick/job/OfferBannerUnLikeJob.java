 ...
 */
public class OfferBannerUnLikeJob extends Job {
    ...
    public OfferBannerUnLikeJob(String globalID_) {
    ...
    public Response<Post> unlikeOfferBanner() throws IOException {
        ...
        Call<Post> call = service.unlikeBanner(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
