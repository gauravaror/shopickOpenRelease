...
public class BrandUpdateUnLikeJob extends Job {
    @Inject
    ...
    public BrandUpdateUnLikeJob(String globalID_) {
        super(new Params(Priority.MID).groupBy("brandupdateunlike").persist().requireNetwork());
    ...
    public Response<Post> unlikeBrandUpdate() throws IOException {
        ...
        Call<Post> call = service.unlikeBrandUpdate(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
}
