 ...
 */
public class BrandLikeJob extends Job {

    @Inject
    transient Bus eventBus;


    public BrandLikeJob(Long globalID) {
        super(new Params(Priority.MID).groupBy("brandlike").persist().requireNetwork());
    ...
    public Response<Post> likeBrand() throws IOException {
        ...
        Call<Post> call = service.likeBrand(globalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
