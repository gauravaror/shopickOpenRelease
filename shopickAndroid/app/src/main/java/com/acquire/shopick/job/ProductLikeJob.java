 ...
 */
public class ProductLikeJob extends Job {
    ...
    public ProductLikeJob(String globalID) {
        super(new Params(Priority.MID).groupBy("product like").persist().requireNetwork());
        this.globalID = globalID;
    }
    ...
    public Response<Post> likeProduct() throws IOException {
        ...
        Call<Post> call = service.likeProduct(requestGlobalID, AccountUtils.getRequestMap(ShopickApplication.getInstance()));
        return call.execute();
    }
